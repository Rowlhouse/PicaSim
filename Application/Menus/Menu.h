...
public:
  ...
  virtual int32_t Update(bool keepAwake, bool throttle, bool& resourcesHaveChanged, const struct GameSettings& gameSettings);

protected:
  uint32_t mUpdateCounter; // frame counter
