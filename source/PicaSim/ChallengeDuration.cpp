...
void ChallengeDuration::GxRender(int renderLevel, DisplayConfig& displayConfig)
{
  ...
  IwGxFontSetRect(CIwRect(displayConfig.mLeft,(int16)(displayConfig.mBottom + displayConfig.mHeight - (0.5f * (numLines + 1.0f) * fontHeight * 1.2f)),(int16)displayConfig.mWidth, fontHeight));
