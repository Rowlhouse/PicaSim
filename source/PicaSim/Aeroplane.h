...
private:
  ...
  struct SoundSetting
  {
    SoundSetting() : mSound(0), mSoundChannel(-1), mMinSpeedRelAir(0), mFreqScalePerSpeed(0), mMinFreqScale(0), mMaxFreqScale(0), mVolScalePerSpeed(0), mVolPow(1), mMaxVolume(0) {}
