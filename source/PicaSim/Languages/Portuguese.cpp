...
void InitStringsPT(const char** txt)
{
  ...
  txt[PS_WHATSNEW] = "Bem-vindo ao PicaSim!";
...
"\n";
  ...
  txt[PS_NUMWINDSTREAMERS] = "Núm. fitas de vento";
  txt[PS_WINDSTREAMERTIME] = "Tempo fitas de vento";
  txt[PS_WINDSTREAMERDELTAZ] = "DeltaZ fitas de vento";
  txt[PS_GRAPHICSSETTINGS] = "Configurações gráficas";
  txt[PS_GROUNDTERRAINLOD] = "LOD terreno solo";
  txt[PS_AEROPLANETERRAINLOD] = "LOD terreno avião";
  ...
  txt[PS_SHADOWBLURMULTIPLIER] = "Multiplicador de desfoque de sombra";
  txt[PS_BLOB] = "Mancha";
  ...
  txt[PS_DEADAIRTURBULENCE] = "Turbulência ar parado";
  ...
  txt[PS_CORERADIUS] = "Raio do núcleo";
  txt[PS_DOWNDRAFTEXTENT] = "Extensão corrente descendente";
  txt[PS_UPDRAFTSPEED] = "Velocidade corrente ascendente";
...
"Este procedimento é o mesmo no Windows e Android - visite o site abaixo para um vídeo que descreve isto em mais detalhe.";
  ...
  txt[PS_TIPS14] = "Siga o PicaSim no Facebook para ser notificado de atualizações e planos";
  txt[PS_TIPS15] = "Existe um fórum para o PicaSim no Tapatalk";
  ...
  txt[PS_RACETIP] = "%s\n\nA seta branca aponta para o próximo ponto de passagem.";
  txt[PS_LIMBOTIP] = "%s\n\nAjuste a dificuldade/multiplicador de pontuação em Definições»Opções 2";
  txt[PS_DURATIONTIP] = "%s\n\nProcure térmicas e aterre perto do ponto de lançamento.";
  ...
  txt[PS_NEXT] = "Próximo";
  txt[PS_QUITANDHELP] = "Sair e ajuda";
  txt[PS_CAMERAANDSETTINGS] = "Câmara e definições";
  txt[PS_RESETANDPLAY] = "Reiniciar e reproduzir/pausar";
  txt[PS_THROTTLEANDRUDDER] = "Acelerador/flaps e leme de direção";
  txt[PS_WINDDIRECTION] = "Direção do vento";
  txt[PS_AILERONSANDELEVATOR] = "Ailerons e leme de profundidade";
  txt[PS_FLYINGINFO] = "Voar";
  txt[PS_QUITANDHELPTEXT] = "Quando em pausa, pressione X para voltar ao menu principal, e pressione ? para obter esta ajuda. \n\nDurante o voo, alguns aviões têm botões para alternar entre configurações do controlador (ex.: flaps para cima/baixo) e libertação do cabo de reboque/guincho.";
  txt[PS_CAMERAANDSETTINGSTEXT] = "Quando em pausa, a engrenagem permite aceder às definições. \n\nO olho (disponível apenas em ambientes 3D) permite alterar a câmara/ponto de vista.";
  txt[PS_RESETANDPLAYTEXT] = "Pressione os botões reproduzir/pausar para iniciar e parar a simulação. \n\nUse a seta de retrocesso ao lado para relançar. \n\nOs botões opcionais 1 e 2 são para fumo.";
  txt[PS_THROTTLEANDRUDDERTEXT] = "Dependendo do tipo de avião, mova o controlador para a esquerda/direita para controlar o leme de direção, e para cima/baixo para controlar o acelerador ou travões. \n\nPlanadores de dois canais não terão este controlo.";
  txt[PS_WINDDIRECTIONTEXT] = "Se houver vento, a seta azul mostra a sua direção. \n\nPodem também aparecer números com informações básicas de voo como velocidade e altitude.";
  txt[PS_AILERONSANDELEVATORTEXT] = "Por defeito, mova o controlador para a esquerda/direita para controlar os ailerons (direção), e para cima/baixo para controlar o leme de profundidade (descer/subir). \n\nPilotos de R/C: O modo do transmissor pode ser alterado no painel Definições»Opções.";
  txt[PS_FLYINGINFOTEXT] = "Aprender a voar requer tempo e prática - tal como voar um avião R/C real. \n\nPara mais orientação, use o botão de ajuda no menu principal.";
  ...
  txt[PS_VRPANORAMAEXTENSION] = "Extensão Panorama VR";
  txt[PS_VROVERLAYDISTANCE] = "Distância sobreposição VR";
  txt[PS_VROVERLAYSCALE] = "Escala sobreposição VR";
  txt[PS_VRUISCALE] = "Escala menu VR";
  txt[PS_MIRROR_TEXT] = "Headset VR em uso";
  txt[PS_MIRROR_SETTINGS] = "Espelhar o ecrã VR nas Definições";
  ...
  txt[PS_FAILEDTOLOADENVIRONMENT] = "Falha ao carregar o ambiente - por favor carregue uma das predefinições de cenário e tente novamente";
}
